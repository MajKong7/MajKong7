...
Accuracy was enforced structurally. Three research groups wrote independent code, we shared nothing. Every system concept tested was verified between groups, i.e. at least two groups ran an identical set of parameter combinations, compared results, and flagged any discrepancies that mismatched at three decimals. All discrepancies were explained, or resolved, before launching any large-scale simulation runs. 
